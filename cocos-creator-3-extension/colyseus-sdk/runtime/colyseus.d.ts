...
declare class HTTP {
	...
	get<T = any>(path: string, options?: Partial<UniRequestOptions>): Promise<UniResponse<T>>;
	post<T = any>(path: string, options?: Partial<UniRequestOptions>): Promise<UniResponse<T>>;
	del<T = any>(path: string, options?: Partial<UniRequestOptions>): Promise<UniResponse<T>>;
	put<T = any>(path: string, options?: Partial<UniRequestOptions>): Promise<UniResponse<T>>;
